            ...
            <form onSubmit={handleSubmit} className="bg-gray-800 rounded-lg border border-gray-700 p-6">
              ...
              <div className="flex items-start mb-6">
                ...
                <label htmlFor="terms" className="ml-2 text-sm text-gray-300">
                  I confirm that I am over 21 years old and agree to the <Link to="/terms-of-service" className="text-amber-500 hover:text-amber-400">Terms of Service</Link>.
                </label>
              </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-4">
                <Link to="/cart" className="btn-secondary order-2 sm:order-1">
                  Back to Cart
                </Link>
